...
from app.api.v1.endpoints import analysis, assistant, auth, datasets, hermes, join, reports, transform
...
api_router.include_router(hermes.router, prefix="/assistant/hermes", tags=["Hermes Assistant"])
api_router.include_router(join.router, prefix="/assistant/join", tags=["Analysis Dataset Builder"])
